...
JSONEditor.defaults.editors.object = JSONEditor.AbstractEditor.extend({
  ...
  build: function() {
    ...
    // If the object should be rendered as a div
      ...
      if(this.schema.options && typeof this.schema.options.hide_title !== "undefined") {
...
JSONEditor.defaults.editors.array = JSONEditor.AbstractEditor.extend({
  ...
  hideDeleteLastRowBtn: function () {
    if (this.delete_last_row_button) {
      this.delete_last_row_button.style.display = 'none';
    }
  },

  showDeleteLastRowBtn: function () {
    if (this.delete_last_row_button) {
      this.delete_last_row_button.style.display = '';
    }
  },

  hideDeleteAllBtn: function () {
  ...
  refreshValue: function(force) {
    ...
    if(oldi !== this.value.length || force) {
      ...
      if(!this.value.length) {
        this.hideDeleteLastRowBtn();
        this.hideDeleteAllBtn();
      }
  ...
  addControls: function() {
    ...
    if (!(this.options.disable_delete_last_row_button || this.jsoneditor.options.disable_delete_last_row_button)) {
